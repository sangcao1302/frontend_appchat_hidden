...
const Policy = () => {
    ...
    return (
        <div className="terms-container">
            ...
            <h2>2. Yêu Cầu Độ Tuổi</h2>
            <p>Ứng dụng này chỉ dành cho người dùng từ 18 tuổi trở lên. Bằng cách sử dụng ứng dụng, bạn xác nhận rằng bạn đã đủ 18 tuổi. Nếu bạn chưa đủ 18 tuổi, vui lòng không sử dụng ứng dụng này.</p>

            <h2>3. Quyền Sử Dụng</h2>
